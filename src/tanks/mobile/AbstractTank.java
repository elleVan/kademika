...
//        Action action = buildPathsPart(destX, destY);
//
//    }

    public Action buildPathsPart(int destX, int destY) {
        int firstX = x;
        int firstY = y;
        ...
        while (path.get(0) instanceof Direction) {
        ...
        if ((Action) path.get(0) == Action.MOVE) {
