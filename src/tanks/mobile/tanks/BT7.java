...
public class BT7 extends AbstractTank {
    ...
    public Image[] createImages() {
        ...
        try {
            array[0] = ImageIO.read(getClass().getResource("/tanks/images/tankBlue-U.png"));
            array[1] = ImageIO.read(getClass().getResource("/tanks/images/tankBlue-D.png"));
            array[2] = ImageIO.read(getClass().getResource("/tanks/images/tankBlue-L.png"));
            array[3] = ImageIO.read(getClass().getResource("/tanks/images/tankBlue-R.png"));
        } catch (IOException e) {
