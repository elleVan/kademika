...
public class Tiger extends AbstractTank {
    ...
    public Image[] createImages() {
        ...
        try {
            array[0] = ImageIO.read(new File("tankRed-U.png"));
            array[1] = ImageIO.read(new File("tankRed-D.png"));
            array[2] = ImageIO.read(new File("tankRed-L.png"));
            array[3] = ImageIO.read(new File("tankRed-R.png"));
        } catch (IOException e) {
